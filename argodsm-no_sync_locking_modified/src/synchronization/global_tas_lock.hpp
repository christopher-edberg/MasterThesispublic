	...
	namespace globallock {
		...
		class global_tas_lock {
			private:
				...
				/**
				 * @brief If this is true, no synchronization will be performed on
				 * lock or unlock and is left to the discretion of the user.
			...
			public:
				 ...
				 * @param _no_synchronize If this is true, lock, trylock and unlock
				 * will perform no ArgoDSM synchronization.
				 */
				global_tas_lock(std::size_t* f, bool _no_synchronize = false) :
					lastuser(global_size_t(f)),
