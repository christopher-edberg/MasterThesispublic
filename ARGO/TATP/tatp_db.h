...
#define NUM_SUBSCRIBERS 2*2097152
#define NUM_OPS_PER_CS 2
#define NUM_OPS 2*2048000//10000 //For verification NUM_OPS has to be devisible by NUM_THREADS*numtasks.numtasks i.e. number of nodes.
